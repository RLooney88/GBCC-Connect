...
class _AddContactWidgetState extends State<AddContactWidget> {
  ...
  void initState() {
    ...
    _model.nameFieldTextController ??=
        TextEditingController(text: _model.fullName);
    _model.nameFieldFocusNode ??= FocusNode();

    _model.positionTitleTextController ??=
        TextEditingController(text: _model.jobTitle);
    _model.positionTitleFocusNode ??= FocusNode();

    _model.companyTextController ??=
        TextEditingController(text: _model.company);
    _model.companyFocusNode ??= FocusNode();

    _model.emailTextController ??= TextEditingController(text: _model.email);
    ...
    _model.websiteTextController ??=
        TextEditingController(text: _model.website);
    _model.websiteFocusNode ??= FocusNode();

    _model.notesTextController ??= TextEditingController(text: _model.notes);
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Container(
                      width: 300.0,
                      child: TextFormField(
                        controller: _model.positionTitleTextController,
                        ...
                        onChanged: (_) => EasyDebounce.debounce(
                          ...
                          () async {
                            _model.jobTitle =
                                _model.positionTitleTextController.text;
                          },
                        ),
                        autofocus: false,
                        obscureText: false,
                        ...
                        cursorColor: FlutterFlowTheme.of(context).primaryText,
                        validator: _model.positionTitleTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (_) => EasyDebounce.debounce(
                          ...
                          Duration(milliseconds: 2000),
                          () async {
                            _model.company = _model.companyTextController.text;
                          },
                        ),
                        autofocus: false,
                        obscureText: false,
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (_) => EasyDebounce.debounce(
                          ...
                          Duration(milliseconds: 2000),
                          () async {
                            _model.email = _model.emailTextController.text;
                          },
                        ),
                        autofocus: false,
                        obscureText: false,
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (_) => EasyDebounce.debounce(
                          ...
                          Duration(milliseconds: 2000),
                          () async {
                            _model.website = _model.websiteTextController.text;
                          },
                        ),
                        autofocus: false,
                        obscureText: false,
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (_) => EasyDebounce.debounce(
                          ...
                          Duration(milliseconds: 2000),
                          () async {
                            _model.notes = _model.notesTextController.text;
                          },
                        ),
                        autofocus: false,
                        obscureText: false,
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(0.0, 15.0, 8.0, 0.0),
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (selectedMedia != null &&
                              ...
                              safeSetState(() =>
                                  _model.isDataUploading_uploadDataRfm = true);
                              ...
                              try {
                                ...
                                _model.isDataUploading_uploadDataRfm = false;
                              }
                              if (selectedUploadedFiles.length ==
                                  selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_uploadDataRfm =
                            ...
                            _model.cardImage = _model.cardImage;
                            safeSetState(() {});
                          },
                          text: 'Scan  Card',
