...
DocumentReference? get currentUserReference =>
    loggedIn ? ContactsRecord.collection.doc(currentUser!.uid) : null;

ContactsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : ContactsRecord.getDocument(ContactsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
